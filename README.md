...
1. In **Build and deployment → Source** scegli **Deploy from a branch**, branch `main`, cartella `/ (root)`. Salva.
1. Dopo qualche minuto il sito sarà su:
   `https://<tuo-utente>.github.io/forge-fit/`

## Installare su iPhone

1. Apri il link in **Safari**.
1. Tocca **Condividi** → **Aggiungi alla schermata Home**.
1. Si apre a tutto schermo con la sua icona, come un’app. Dopo il primo avvio funziona anche offline.
